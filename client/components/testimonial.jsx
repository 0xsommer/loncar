...
export default function Testimonial () {
  return (
    <section className="py-12 bg-gray-100 rounded-2xl overflow-hidden md:pb-20 md:pt-16 mb-16 md:mb-4 border border-black/5 dark:text-white dark:bg-black/30 ">
